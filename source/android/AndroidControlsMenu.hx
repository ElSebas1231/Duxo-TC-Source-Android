...
class AndroidControlsMenu extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		var titleText:Alphabet = new Alphabet(75, 60, "Controles de Android", true);
		...
		upPozition = new FlxText(10, FlxG.height - 104, 0,"X del Botón UP: " + vpad.buttonUp.x +" Y del Botón UP: " + vpad.buttonUp.y, 16);
		...
		downPozition = new FlxText(10, FlxG.height - 84, 0,"X del Botón DOWN: " + vpad.buttonDown.x +" Y del Botón DOWN: " + vpad.buttonDown.y, 16);
		...
		leftPozition = new FlxText(10, FlxG.height - 64, 0, "X del Botón LEFT: " + vpad.buttonLeft.x +"Y del Botón LEFT: " + vpad.buttonLeft.y, 16);
		...
		rightPozition = new FlxText(10, FlxG.height - 44, 0,"X del Botón RIGHT: " + vpad.buttonRight.x +" Y del Botón RIGHT: " + vpad.buttonRight.y, 16);
		...
		var tipText:FlxText = new FlxText(10, FlxG.height - 24, 0, 'Presiona BACK para volver al menú de Opciones', 16);
	...
	function changeSelection(change:Int = 0)
	{
		...
		{
		if(ClientPrefs.hitboxmode != 'Nuevo'){
			hbox.visible = true;
		     }else{
	...
	function setbuttontexts() {
		upPozition.text = "X del Botón UP: " + vpad.buttonUp.x +" Y del Botón UP: " + vpad.buttonUp.y;
		downPozition.text = "X del Botón DOWN: " + vpad.buttonDown.x +" Y del Botón DOWN: " + vpad.buttonDown.y;
		leftPozition.text = "X del Botón LEFT: " + vpad.buttonLeft.x +" Y del Botón LEFT: " + vpad.buttonLeft.y;
		rightPozition.text = "X del Botón RIGHT: " + vpad.buttonRight.x +" Y del Botón RIGHT: " + vpad.buttonRight.y;
	}
